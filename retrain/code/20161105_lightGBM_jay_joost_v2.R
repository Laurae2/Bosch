...
train <- readRDS("../input/joost_jay_v2/train.rds")
test <- readRDS("../input/joost_jay_v2/test.rds")
label <- readRDS("../input/jay/labels.rds")


library(feather)
write_feather(train,'../input/joost_jay_v2/train.feather')
write_feather(test,'../input/joost_jay_v2/test.feather')
...
# Feature Set
destination_joost <- fread("../input/joost_jay_v2/feat_set_destination_station_S32.csv")
ids <- data.table(ID = destination_joost$ID)
destination_joost[, ID := NULL]
destination_joost[, "S32_dest_-1.0" := NULL]
date_joost <- fread("../input/joost_jay_v2/feat_set_date_all_compressed.csv")
...
# Feature Set
jayjay_joost <- fread("../input/joost_jay_v2/feat_set_jayjay_same_L_new.csv")
...
write.csv(validations,'../pushing/20161105_lightGBM_train_feature_se11.csv',row.names = F)
write.csv(test_predictions,'../pushing/20161105_lightGBM_test_feature_set11.csv',row.names = F)
