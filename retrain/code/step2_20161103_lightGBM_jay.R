...
write_feather(train,'../input/jay/train.feather')
write_feather(test,'../input/jay/test.feather')
...
write.csv(validations,'../pushing/20161103_lightGBM_train_feature_set2.csv',row.names = F)
write.csv(test_predictions,'../pushing/20161103_lightGBM_test_feature_set2.csv',row.names = F)
