...
train <- readRDS("../input/jay/train.rds")
test <- readRDS("../input/jay/test.rds")
...
# Load extra data
train_numeric <- readRDS("../input/jay/xgb_train.rds")
test_numeric <- readRDS("../input/jay/xgb_test.rds")
...
destination_joost <- fread("../input/jay/feat_set_destination_station_S32.csv")
destination_joost[, ID := NULL]
date_joost <- fread("../input/jay/feat_set_date_all_compressed.csv")
...
write_feather(train,'../input/jay/tr_jay_joost.feather')
write_feather(test,'../input/jay/te_jay_joost.feather')
...
write_feather(train,'../input/joost_jay/train_joost.feather')
write_feather(test,'../input/joost_jay/test_joost.feather')
...
best_model <- readRDS(file.path(my_script_is_using, "aaa_LightGBM_full.rds"))
...
write.csv(validations,'../pushing/20161104_lightGBM_train_feature_set7.csv',row.names = F)
write.csv(test_predictions,'../pushing/20161104_lightGBM_test_feature_set7.csv',row.names = F)
