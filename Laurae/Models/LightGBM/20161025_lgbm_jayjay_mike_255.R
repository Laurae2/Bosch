...
my_script_is_using <- "E:/Laurae/20161025_lgbm_jayjay_mike_255"
...
train_data[, magic1 := NULL]
train_data[, magic2 := NULL]
train_data[, magic3 := NULL]
train_data[, magic4 := NULL]
train_data[, magic5 := NULL]
train_data[, magic6 := NULL]
test_data[, magic1 := NULL]
test_data[, magic2 := NULL]
test_data[, magic3 := NULL]
test_data[, magic4 := NULL]
test_data[, magic5 := NULL]
test_data[, magic6 := NULL]


train <- DTcbind(train, train_data, low_mem = TRUE, collect = 20, silent = FALSE)
test <- DTcbind(test, test_data, low_mem = TRUE, collect = 20, silent = FALSE)
