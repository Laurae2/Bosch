...
my_script_is_using <- "E:/Laurae/20161110_xgb_jayjoost_fix"
...
predictions1 <- fread("Laurae/20161110_xgb_jayjoost/predictions_oof.csv")$x
predictions3 <- fread("Laurae/20161110_xgb_jayjoost/predictions_test_raw.csv")
predictions2 <- predictions3[[2]] + predictions3[[3]] + predictions3[[4]] + predictions3[[5]]
best_iter <- 0
