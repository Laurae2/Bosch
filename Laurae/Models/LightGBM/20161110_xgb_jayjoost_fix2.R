...
my_script_is_using <- "E:/Laurae/20161110_xgb_jayjoost_fix2"
...
train <- readRDS("Laurae/Final_Data/xgb_train_mat.rds")
test <- readRDS("Laurae/Final_Data/xgb_test_mat.rds")
...
predictions1 <- fread("Laurae/20161110_xgb_jayjoost_fix/predictions_oof.csv")$x
predictions3 <- fread("Laurae/20161110_xgb_jayjoost_fix/predictions_test_raw.csv")
predictions2 <- predictions3[[1]] + predictions3[[2]] + predictions3[[3]] + predictions3[[5]]
best_iter <- 0
...
predictions2 <- (predictions3[[1]] + predictions3[[2]] + predictions3[[3]] + predictions3[[4]] + predictions3[[5]]) / 5
gc(verbose = FALSE)
