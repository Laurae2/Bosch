...
my_script_is_using <- "E:/Laurae/20161025_lgbm_jayjay_magic_255"
...
#dist_data <- fread("Mike/0 - Data Files/lead_lag_data.csv")

#dist_data[, Response := NULL]

train[, magic1 := train_data$magic1]
train[, magic2 := train_data$magic2]
train[, magic3 := train_data$magic3]
train[, magic4 := train_data$magic4]
train[, magic5 := train_data$magic5]
train[, magic6 := train_data$magic6]
test[, magic1 := test_data$magic1]
test[, magic2 := test_data$magic2]
test[, magic3 := test_data$magic3]
test[, magic4 := test_data$magic4]
test[, magic5 := test_data$magic5]
test[, magic6 := test_data$magic6]
