...
my_script_is_using <- "E:/Laurae/20161110_xgb_lv2"
...
train[, "xgb_jay_joost_v2"] <- fread("Laurae/20161110_xgb_jayjoost_fix/aaa_stacker_preds_train_headerY_scale.csv")$x
test[, "xgb_jay_joost_v2"] <- fread("Laurae/20161110_xgb_jayjoost_fix/aaa_stacker_preds_test_headerY_scale.csv")$x
...
# train <- train[, c(1:2, 14:139)]
# test <- test[, c(1:2, 14:139)]
train <- train[, c(1:12, 138:139)]
test <- test[, c(1:12, 138:139)]
