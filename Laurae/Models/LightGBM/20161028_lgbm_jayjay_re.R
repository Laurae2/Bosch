...
my_script_is_using <- "E:/Laurae/20161028_lgbm_jayjay_re"
...
AnalysisFunc <- function(lgbm, label, folds, validationValues, predictedValuesCV, predictedValues) {
  ...
  cat("Submission with all data by taking the sum of positives of validated threshold positives: ", best_count_extra, ". Threshold=", best_mcc_extra, "\n\n", sep = "")
