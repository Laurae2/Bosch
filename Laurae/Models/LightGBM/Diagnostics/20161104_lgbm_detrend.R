...
my_script_is_using <- "E:/Laurae/20161104_lgbm_detrend"
...
date_joost <- DTcolsample(date_joost, kept = c(5, 6, 7, 14, 15, 16, 20))
...
# Feature Set
detrend_joost <- fread("Joost/feat_set_numeric_detrended_sum_stationV2.csv")
detrend_joost[, ID := NULL]
DTfillNA(detrend_joost, value = 65536, low_mem = TRUE, collect = 32, silent = FALSE)

train_joost <- detrend_joost[1:1183747, ]
test_joost <- detrend_joost[1183748:2367495, ]

train <- DTcbind(train, train_joost, low_mem = TRUE, collect = 32, silent = FALSE)
test <- DTcbind(test, test_joost, low_mem = TRUE, collect = 32, silent = FALSE)
rm(train_joost, test_joost, detrend_joost)
gc()
