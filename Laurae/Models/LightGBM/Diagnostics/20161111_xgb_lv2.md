...
Submission overfitted threshold on all MCC positives: 2941

Submission average validated threshold on all MCC positives: 3226

Submission average of overfit+validated threshold positives: 3077

Submission with all data overfitted threshold on all MCC positives: 4008. Threshold=0.3409621

Submission with all data average validated threshold on all MCC positives: 5000. Threshold=0.3145569

Submission with all data average of overfit+validated threshold positives: 4420. Threshold=0.3277595

Submission with all data by taking the amount of positives of overfitted threshold on all MCC positives: 2941. Threshold=0.4169117

Submission with all data by taking the amount of positives of average validated threshold on all MCC positives: 3226. Threshold=0.3864948

Submission with all data by taking the amount of positives of average of overfit+validated threshold positives: 3077. Threshold=0.4014918

Submission with all data by taking the sum of positives of validated positives: 2751. Threshold=0.43946

Submission with all data by taking the sum of positives of validated positives: 3164. Threshold=0.3931929
It needs -26.68% TP to hold true.
