...
AnalysisFunc <- function(label, folds, validationValues, predictedValuesCV, predictedValues) {
  ...
  # folds = your fold list, mandatory
  # validationValues = your validation (out of fold) values (out of fold predictions), mandatory
  # predictedValuesCV = your averaged predicted (test) values (on test data) from CV (set as "NA" if you don't have any)
  # predictedValues = your prediction (test) values (on test data) on a model trained on all data (set as "NA" if you don't have any)
