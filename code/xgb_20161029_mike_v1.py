...
if __name__ == "__main__":
    ...
    xgb_result_set1.to_csv('../stacking_new/level1_train_20161029_feature_set3.csv',index = False)
    ...
    y_pred_final = (((test_rf ) > threshold2*0.95).astype(int))
    submission = pd.read_csv('../input/sample_submission.csv')
    submission['Response'] = y_pred_final
    print(sum(y_pred_final))
    submission[['Id', 'Response']].to_csv('../submission/xgboost_20161023_submit5_rf.csv', index=False)
