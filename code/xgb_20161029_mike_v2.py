...
if __name__ == "__main__":
    ...
    xgb_result_set1.to_csv('../stacking_new/level1_train_20161029_feature_set5.csv',index = False)
    rf_result_set1.to_csv('../stacking_new/level1_train_20161029_feature_set6.csv',index = False)
    ...
    xgb_result_set1_test.to_csv('../stacking_new/level1_test_20161029_feature_set5.csv',index = False)
    rf_result_set1_test.columns = ['pred']
    rf_result_set1_test['pred'] = test_rf
    rf_result_set1_test.to_csv('../stacking_new/level1_test_20161029_feature_set6.csv',index = False)
