...
if __name__ == "__main__":
    ...
    train = pd.concat([tr_feather_set1,tr_lauren],axis = 1)
    test = pd.concat([te_feather_set1,te_lauren], axis=1)
    import gc
    gc.collect()
    ...
    xgb_result_set1.to_csv('../stacking_new/level1_train_20161029_feature_set11.csv',index = False)
    rf_result_set1.to_csv('../stacking_new/level1_train_20161029_feature_set12.csv',index = False)
    ...
    clf_xgb = xgb.train(params, dtrain, num_boost_round=70)
    ...
    xgb_result_set1_test.to_csv('../stacking_new/level1_test_20161029_feature_set11.csv',index = False)
    rf_result_set1_test.columns = ['pred']
    rf_result_set1_test['pred'] = test_rf
    rf_result_set1_test.to_csv('../stacking_new/level1_test_20161029_feature_set12.csv',index = False)
