...
if __name__ == "__main__":
    ...
    train = pd.concat([tr_feather_set1,train_numeric],axis = 1)
    test = pd.concat([te_feather_set1,train_numeric], axis=1)
    import gc
    gc.collect()
    ...
    xgb_result_set1.to_csv('../stacking_new/level1_train_20161029_feature_set7.csv',index = False)
    rf_result_set1.to_csv('../stacking_new/level1_train_20161029_feature_set8.csv',index = False)
